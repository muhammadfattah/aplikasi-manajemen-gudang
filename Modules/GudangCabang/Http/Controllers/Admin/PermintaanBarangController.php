...
class PermintaanBarangController extends GudangCabangController
{
    // use Authorizable;
    ...
    public function index(Request $request)
    {
        ...
        return view('gudangcabang::admin.permintaanbarang.index', $this->data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($status == '') {
            return redirect('admin/gudang-cabang/permintaan-order')
